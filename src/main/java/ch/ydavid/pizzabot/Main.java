    ...
    public static void main(String[] args) throws LoginException, InterruptedException, IOException {
        ...
        for (Guild guild : api.getGuilds()) {
            if (guild != null) {
                ...
                guild.upsertCommand("hide", "Hide's your Voice Channel").queue();
                guild.upsertCommand("limit", "Limits your Voice Channel").addOption(OptionType.NUMBER, "limit", "Limit", true).queue();
